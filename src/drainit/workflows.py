...
class CulvertCapacity(WorkflowManager):
    ...
    def _analyze_all_points(self):
        ...
        self.gp.msg("analyzing multi-culvert crossings")
        for mcc in multiculvert_crossing_group_ids:
        ...
        self.gp.msg("calculating summary analytics")
